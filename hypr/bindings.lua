...
hl.bind(mainMod .. " + CTRL + B", hl.dsp.exec_cmd("kitty --class float-small -e bluetui"))
...
hl.bind(mainMod .. " + CTRL + V", hl.dsp.exec_cmd("kitty --class float-small -e vpn-connect"))
hl.bind(mainMod .. " + CTRL + W", hl.dsp.exec_cmd("kitty --class float -e wallapper"))
hl.bind(mainMod .. " + CTRL + SHIFT + W", hl.dsp.exec_cmd("kitty --class float -e wallapper --g"))
...
hl.bind(mainMod .. " + CTRL + A", hl.dsp.exec_cmd("kitty --class float-small -e wiremix"))
